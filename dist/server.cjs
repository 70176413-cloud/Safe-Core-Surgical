...
async function startServer() {
  ...
  app.post("/api/send-inquiry", async (req, res) => {
    try {
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 12px; line-height: 1.6; color: #52525b;">
                        <tr>
                          ...
                          <td width="50%" valign="top">
                            ...
                            Phone: ${phone}<br />
                            Date Submitted: ${date || (/* @__PURE__ */ new Date()).toISOString().split("T")[0]}
                          </td>
                        </tr>
                      </table>
                    </td>
                        ...
                        <tfoot>
                          <tr>
                            <td colspan="2" style="padding: 24px 0 0 0; font-size: 11px; color: #71717a;">
                              ...
                              <span style="color: #15803d; font-weight: bold;">\u2713 APPROVED MOIST-HEAT AUTOCLAVE OK (134\xB0C)</span>
                            </td>
      ...
      if (usingFallback) {
        testPreviewUrl = import_nodemailer.default.getTestMessageUrl(info) || "";
